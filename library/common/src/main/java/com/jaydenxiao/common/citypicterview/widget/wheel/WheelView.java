...
package com.jaydenxiao.common.citypicterview.widget.wheel;
...
import com.jaydenxiao.common.citypicterview.widget.wheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
    ...
    //分割线左边距
    private float dividelineLeft = 0;
    //分割线右边距
    private float dividelineRight = 0;
    ...
    public void setDividePadding(float padingleft, float padingrifht) {
        dividelineLeft = padingleft;
        dividelineRight = padingrifht;
    }

    private boolean hasDivideLine = true;

    public void setHasDivideLine(boolean b) {
        hasDivideLine = b;
    }
...
//        Log.d("liji.wheel", "visibleItems:" + visibleItems);
    ...
    private void drawCenterRect(Canvas canvas) {
      ...
      if(hasDivideLine){
          // 绘制上边直线
          canvas.drawLine(dip2px(dividelineLeft), center - offset, getWidth() - dip2px(dividelineRight), center - offset, paint);
          // 绘制下边直线
          canvas.drawLine(dip2px(dividelineLeft), center + offset, getWidth() - dip2px(dividelineRight), center + offset, paint);
          //*/
      }
