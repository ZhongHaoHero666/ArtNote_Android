...
public class LoadingTip extends LinearLayout {
    ...
    public static enum LoadStatus {
        sereverError,error, empty, loading,custom,finish
    }
...
//            tv_tips.setText(tips);
     ...
     * @param loadStatus
     */
    public void setLoadingTip(LoadStatus loadStatus,int drawableId){
        switch (loadStatus){
            case empty:
...
//                    tv_tips.setText(errorMsg);
//                }
                img_tip_logo.setImageResource(R.drawable.no_internet);
                break;
            case loading:
                setVisibility(View.VISIBLE);
...
//                    tv_tips.setText(errorMsg);
//                }
                img_tip_logo.setImageResource(drawableId);
                break;
            case finish:
                setVisibility(View.GONE);
                break;
