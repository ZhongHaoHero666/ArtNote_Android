 ...
 * 本地数据库
 */
public class CityPickerLocalDb implements CanShow, OnWheelChangedListener, OnWheelScrollListener {
...
//    protected Map<String, String> mZipcodeDatasMap = new HashMap<String, String>();
    ...
    public CityPickerLocalDb setDefaultProvinceName(String defaultProvinceName) {
        this.defaultProvinceName = defaultProvinceName;
        return this;
    }


    public CityPickerLocalDb setDefaultCityName(String defaultCityName) {
    ...
    public CityPickerLocalDb setShowProvinceAndCity(boolean showProvinceAndCity) {
    ...
    public CityPickerLocalDb setShowBankChoices(boolean showBankChoices) {
        this.showBankChoices = showBankChoices;
        return this;

    }

    public static CityPickerLocalDb GetcitiPicter(Context context, FragmentManager fragmentManager) {

        return new CityPickerLocalDb(context, fragmentManager);
    }

    private CityPickerLocalDb(final Context context, FragmentManager fragmentManager) {
...
//                mCurrentCityName = cityList.get(mViewCity.getCurrentItem()).getName();
//                mCurrentDistrictName = districtList.get(mViewDistrict.getCurrentItem()).getName();
//                String proinceCode = provinceList.get(mViewProvince.getCurrentItem()).getId() + "";
//                String cityCode = cityList.get(mViewCity.getCurrentItem()).getId() + "";
//                String districtCode = districtList.get(mViewDistrict.getCurrentItem()).getId() + "";
//                if (showProvinceAndCity) {
//                    listener.onSelected(mCurrentProviceName, mCurrentCityName, proinceCode, cityCode);
//                } else {
//                    listener.onSelected(mCurrentProviceName, mCurrentCityName, mCurrentDistrictName, proinceCode, cityCode, districtCode);
...
//        }
//
//        public CityPickerLocalDb build() {
//            CityPickerLocalDb cityPicker = new CityPickerLocalDb(this);
//            return cityPicker;
//        }
//
//    }
...
//        arrayWheelAdapter.setTextColor(textColor);
        ...
        setItemTextSize(provinceList.get(0).getName(), arrayWheelAdapter);
        updateCities();
        updateAreas();
...
//        cityWheel = new ArrayWheelAdapter(context, cityList);
        // 设置可见条目数量
